...
#:
#: **Add a marine layer here in the same commit that adds the layer**, because
#: the failure is silent: the sheet simply stops warning, and looks perfectly
#: fine doing it. A drawing of where the water goes is at least as actionable as
#: a depth — more so, for anything under way.
MARINE_LAYERS: frozenset[str] = frozenset(
    {"bathymetry", "depth_bands", "current_streamlines", *SEAMARK_LAYERS}
)
